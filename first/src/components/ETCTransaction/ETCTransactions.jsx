...
import ETCTransaction_Table from './ETCTransaction_Table';

function ETCTransactions({ user, onLogout }) {
...
          </div>
         ...
         <div>
         <ETCTransaction_Table rows={data} />
         </div>
        </div>
      </div>
...
export default ETCTransactions;
